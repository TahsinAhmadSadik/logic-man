...
import prob41 from './prob_41.json';
import prob42 from './prob_42.json';
import prob43 from './prob_43.json';
import prob44 from './prob_44.json';
import prob45 from './prob_45.json';
import prob46 from './prob_46.json';
import prob47 from './prob_47.json';
import prob48 from './prob_48.json';
// import prob49 from './prob_49.json';
import prob50 from './prob_50.json';
...
import prob61 from './prob_61.json';
import prob62 from './prob_62.json';
import prob63 from './prob_63.json';
import prob64 from './prob_64.json';
import prob65 from './prob_65.json';
import prob66 from './prob_66.json';
import prob67 from './prob_67.json';
import prob68 from './prob_68.json';
import prob69 from './prob_69.json';
import prob70 from './prob_70.json';
...
export const PROBLEMS_INDEX = [
  ...
  },
  {
    ...
    numId: prob41.numId,
    title: prob41.title,
    difficulty: prob41.difficulty,
    category: getCategory(prob41),
    tags: prob41.tags || [],
    description: prob41.description
  },
  {
    id: prob42.id,
    numId: prob42.numId,
    title: prob42.title,
    difficulty: prob42.difficulty,
    category: getCategory(prob42),
    tags: prob42.tags || [],
    description: prob42.description
  },
  {
    id: prob43.id,
    numId: prob43.numId,
    title: prob43.title,
    difficulty: prob43.difficulty,
    category: getCategory(prob43),
    tags: prob43.tags || [],
    description: prob43.description
  },
  {
    id: prob44.id,
    numId: prob44.numId,
    title: prob44.title,
    difficulty: prob44.difficulty,
    category: getCategory(prob44),
    tags: prob44.tags || [],
    description: prob44.description
  },
  {
    id: prob45.id,
    numId: prob45.numId,
    title: prob45.title,
    difficulty: prob45.difficulty,
    category: getCategory(prob45),
    tags: prob45.tags || [],
    description: prob45.description
  },
  {
    id: prob46.id,
    numId: prob46.numId,
    title: prob46.title,
    difficulty: prob46.difficulty,
    category: getCategory(prob46),
    tags: prob46.tags || [],
    description: prob46.description
  },
  {
    id: prob47.id,
    numId: prob47.numId,
    title: prob47.title,
    difficulty: prob47.difficulty,
    category: getCategory(prob47),
    tags: prob47.tags || [],
    description: prob47.description
  },
  {
    id: prob48.id,
    numId: prob48.numId,
    title: prob48.title,
    difficulty: prob48.difficulty,
    category: getCategory(prob48),
    tags: prob48.tags || [],
    description: prob48.description
  },
  // {
  //   id: prob49.id,
  //   numId: prob49.numId,
  //   title: prob49.title,
  //   difficulty: prob49.difficulty,
  //   category: getCategory(prob49),
  //   tags: prob49.tags || [],
  //   description: prob49.description
  // },
  {
    id: prob50.id,
    numId: prob50.numId,
    title: prob50.title,
    difficulty: prob50.difficulty,
    category: getCategory(prob50),
    tags: prob50.tags || [],
    description: prob50.description
  },
  {
    id: prob51.id,
    numId: prob51.numId,
  ...
  // },
  {
    ...
    numId: prob61.numId,
    title: prob61.title,
    difficulty: prob61.difficulty,
    category: getCategory(prob61),
    tags: prob61.tags || [],
    description: prob61.description
  },
  {
    id: prob62.id,
    numId: prob62.numId,
    title: prob62.title,
    difficulty: prob62.difficulty,
    category: getCategory(prob62),
    tags: prob62.tags || [],
    description: prob62.description
  },
  {
    id: prob63.id,
    numId: prob63.numId,
    title: prob63.title,
    difficulty: prob63.difficulty,
    category: getCategory(prob63),
    tags: prob63.tags || [],
    description: prob63.description
  },
  {
    id: prob64.id,
    numId: prob64.numId,
    title: prob64.title,
    difficulty: prob64.difficulty,
    category: getCategory(prob64),
    tags: prob64.tags || [],
    description: prob64.description
  },
  {
    id: prob65.id,
    numId: prob65.numId,
    title: prob65.title,
    difficulty: prob65.difficulty,
    category: getCategory(prob65),
    tags: prob65.tags || [],
    description: prob65.description
  },
  {
    id: prob66.id,
    numId: prob66.numId,
    title: prob66.title,
    difficulty: prob66.difficulty,
    category: getCategory(prob66),
    tags: prob66.tags || [],
    description: prob66.description
  },
  {
    id: prob67.id,
    numId: prob67.numId,
    title: prob67.title,
    difficulty: prob67.difficulty,
    category: getCategory(prob67),
    tags: prob67.tags || [],
    description: prob67.description
  },
  {
    id: prob68.id,
    numId: prob68.numId,
    title: prob68.title,
    difficulty: prob68.difficulty,
    category: getCategory(prob68),
    tags: prob68.tags || [],
    description: prob68.description
  },
  {
    id: prob69.id,
    numId: prob69.numId,
    title: prob69.title,
    difficulty: prob69.difficulty,
    category: getCategory(prob69),
    tags: prob69.tags || [],
    description: prob69.description
  },
  {
    id: prob70.id,
    numId: prob70.numId,
    title: prob70.title,
    difficulty: prob70.difficulty,
    category: getCategory(prob70),
    tags: prob70.tags || [],
    description: prob70.description
  },
  {
    id: prob81.id,
    numId: prob81.numId,
