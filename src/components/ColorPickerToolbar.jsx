...
export const ColorPickerToolbar = () => {
  const { selectedColor, setSelectedColor, powerOn, past, future, undo, redo } = useSimulatorStore();
          ...
          return (
            <button
              ...
              className={`w-6 h-6 rounded-full transition-all duration-150 relative ${
                isSelected ? 'scale-125 ring-2 ring-amber-400 ring-offset-2 ring-offset-zinc-900' : 'hover:scale-110'
              }`}
