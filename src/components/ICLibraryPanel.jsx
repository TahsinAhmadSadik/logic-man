...
import { Cpu, Search, X, Lock } from 'lucide-react';
...
export const ICLibraryPanel = () => {
  ...
  const filteredCatalog = IC_CATALOG.filter((ic) => {
    ...
    // Strict Problem Limit Filter:
    // If allowedICLimits exists, strictly hide/lock ICs not listed in allowedICLimits!
            ...
            return (
              <div
                ...
                onClick={() => {
                  ...
                  togglePanel('library'); // Close panel after selecting IC to place
                }}
